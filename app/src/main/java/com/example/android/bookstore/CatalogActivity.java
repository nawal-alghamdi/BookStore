...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // Launch the {@link ProductDetailActivity} to display the data for the current book.
                startActivity(intent);
            }
        });
    ...
    private void insertBook() {
        ...
        values.put(BookEntry.COLUMN_BOOK_TITLE, "Eat Smart");
        values.put(BookEntry.COLUMN_BOOK_AUTHOR, "Niomi");
        values.put(BookEntry.COLUMN_BOOK_PRICE, 120);
        values.put(BookEntry.COLUMN_BOOK_QUANTITY, 10);
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NAME, "Harold");
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NUMBER, 900088878);

        // Insert a new row for Book into the provider using the ContentResolver.
        // Use the {@link BookEntry#CONTENT_URI} to indicate that we want to insert
        // into the books database table.
        // Receive the new content URI that will allow us to access book data in the future.
