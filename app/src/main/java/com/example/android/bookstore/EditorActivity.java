...
/**
 * Allows user to edit an existing book.
 */
public class EditorActivity extends AppCompatActivity implements
    ...
    private void saveBook() {
        ...
        // and check if there is any one of the fields in the editor is blank
        if (!TextUtils.isEmpty(titleString) && !TextUtils.isEmpty(authorString) &&
                !TextUtils.isEmpty(priceString) && !TextUtils.isEmpty(quantityString) &&
                !TextUtils.isEmpty(supplierNameString) && !TextUtils.isEmpty(numberString)) {
            ...
            values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NUMBER, Long.parseLong(numberString));
            ...
            Toast.makeText(this, getString(R.string.can_not_be_saved),
                    Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                // which is the {@link ProductDetailActivity}.
                if (!mBookHasChanged) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mNumberEditText.setText(Long.toString(number));
    ...
    private void deleteBook() {
        ...
        // This will close the other activities (ProductDetailActivity and EditorActivity) and open the catalog activity
