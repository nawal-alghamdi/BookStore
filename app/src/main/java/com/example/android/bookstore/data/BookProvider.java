...
public class BookProvider extends ContentProvider {
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // Check that the book author is not null
        ...
        String name = values.getAsString(BookEntry.COLUMN_BOOK_SUPPLIER_NAME);
        if (name == null) {
        ...
        // Check that the price is greater than or equal to 0 and not null
        ...
        Long number = values.getAsLong(BookEntry.COLUMN_BOOK_SUPPLIER_NUMBER);
        if (number == null) {
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link BookEntry#COLUMN__BOOK_SUPPLIER_NAME} key is present,
        // Check that the supplier name is not null.
        ...
        // If the {@link BookEntry#COLUMN__BOOK_PRICE} key is present,
        // Check that the price is greater than or equal to 0 and not null.
        ...
        // If the {@link BookEntry#COLUMN__BOOK_SUPPLIER_NUMBER} key is present,
        // Check that the supplier number is not null.
